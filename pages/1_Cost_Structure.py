...
def render_layer_editor(layers, key_prefix, total_width, road_length, version=0):
    ...
    SURFACE_KW = ['wearing', 'binder', 'ac base course', 'ac interlayer',
                  'tack coat', 'prime coat', 'geotextile', 'steel reinforcement',
                  'non woven', 'ksc', 'concrete']
            ...
            try:
                ...
                if st.button("📥 นำเข้าข้อมูล", key="import_json"):
                    if 'project_info' in loaded_data:
                        ...
                        # เพิ่ม version บังคับให้ widget keys เปลี่ยน → อ่านค่าใหม่จาก JSON
    ...
    with tab2:
        ...
        with col3:
            ...
            with st.expander(f"● {jrcp1_name}", expanded=True):
                ...
                jrcp1_joints, jrcp1_include_joints = render_joint_editor(_j1 or get_default_jrcp1_joints(), "jrcp1", area_per_km, road_length)
        ...
        with col4:
            ...
            with st.expander(f"● {jrcp2_name}", expanded=True):
                ...
                jrcp2_joints, jrcp2_include_joints = render_joint_editor(_j2 or get_default_jrcp1_joints(), "jrcp2", area_per_km, road_length)
