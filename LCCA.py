                ...
                for k, ฟื้นฟู in enumerate(ทางเลือก.แผนฟื้นฟูสภาพ):
                    ...
                    with col_r1:
                        ...
                        ชื่อกิจกรรมใหม่ = st.text_input(
                            ...
                            key=f"rehab_name_{i}_{k}_{st.session_state[f'rehab_update_version_{i}']}",
                            label_visibility="collapsed"
                        )
                        
                        # เช็คและอัพเดทต้นทุนเมื่อชื่อเปลี่ยน
                        if ชื่อกิจกรรมใหม่ != ชื่อกิจกรรมเก่า:
                            ฟื้นฟู.ชื่อกิจกรรม = ชื่อกิจกรรมใหม่
                            # ถ้าชื่อมี "ก่อสร้างใหม่"
                            if "ก่อสร้างใหม่" in ชื่อกิจกรรมใหม่ or ("ก่อสร้าง" in ชื่อกิจกรรมใหม่ and "ใหม่" in ชื่อกิจกรรมใหม่):
                                ...
                                # เพิ่ม version เพื่อ force update
                    ...
                    with col_r2:
                        ...
                        # ถ้าชื่อมี "ก่อสร้างใหม่" ให้ใช้ต้นทุนก่อสร้าง
                        ...
                        ฟื้นฟู.ต้นทุนต่อหน่วย = st.number_input(
                            ...
                            step=10.0,
                            key=f"rehab_cost_{i}_{k}_{st.session_state[f'rehab_update_version_{i}']}",
                            label_visibility="collapsed",
